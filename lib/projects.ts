...
export const projects: Project[] = [
    ...
    {
        title: 'Video Downloader Website',
        description: 'Created an informative website showcasing the video downloader app features, functionality, and download options. Serves as the official platform for app documentation, user guides, and direct APK distribution. Designed with modern web technologies for optimal presentation and easy access to download links.',
        tags: ['Web Platform', 'Documentation', 'Marketing', 'React'],
        link: 'https://github.com/iam-sandipmaity/video-downloader-site',
        github: 'https://github.com/iam-sandipmaity/video-downloader-site',
    },
